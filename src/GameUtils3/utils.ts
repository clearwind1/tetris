...
module GameUtil {
     ...
     * @param ty    y轴终点坐标
     */
    export function createLine(x: number, y: number, thickness: number, color: number, alpha: number, tx: number, ty: number): egret.Shape {
        var linesp: egret.Shape = new egret.Shape();
    ...
    export function getrect(obj: any): egret.Rectangle {
