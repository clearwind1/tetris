...
class GameConfig {
    ...
    public static GAMENAME: string = '俄罗斯方块';           //游戏在服务器上的名字
    ...
    /**开发游戏配置 */
    public static DICBW = 50;
    public static DICBH = 50;
    public static BROW = 14;         //列数
    public static BCOL = 10;         //行数
    public static OFFSTARTX = 10;    //x位移值
    public static OFFSTARTY = 200;   //y位移值
    public static LINETHICK = 2;
    /**开发游戏配置结束 */
